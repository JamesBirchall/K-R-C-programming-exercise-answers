...
all:	 kandrcchapter8answers.o kandrcchapter7answers.o kandrcchapter6answers.o kandrcchapter5answers.o polishcalc.o kandrcchapter4answers.o kandrcchapter3answers.o kandrcchapter2answers.o kandrcchapter1answers.o main.o 
	gcc kandrcchapter8answers.c kandrcchapter7answers.c kandrcchapter6answers.c kandrcchapter5answers.c polishcalc.c kandrcchapter4answers.c kandrcchapter3answers.c kandrcchapter2answers.c kandrcchapter1answers.c main.c -lm -g -std=c99 -o kandrexercises
...
clean:
	rm -f kandrexercises kandrcchapter8answers.o kandrchapter7answers.o kandrcchapter6answers.o kandrcchapter5answers.o polishcalc.o kandrcchapter4answers.o kandrcchapter3answers.o kandrcchapter2answers.o kandrcchapter1answers.o
